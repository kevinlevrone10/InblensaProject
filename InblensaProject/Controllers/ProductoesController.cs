...
namespace InblensaProject.Controllers
{
    ...
    public class ProductoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID_Producto,Nombre,Descripcion,Precio")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID_Producto,Nombre,Descripcion,Precio")] Producto producto)
        {
