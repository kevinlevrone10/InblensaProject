...
namespace InblensaProject.Controllers
{
    ...
    public class ProveedorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID_Proveedor,Nombre,Direccion,Telefono,Email")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID_Proveedor,Nombre,Direccion,Telefono,Email")] Proveedor proveedor)
        {
